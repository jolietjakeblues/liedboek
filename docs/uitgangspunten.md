...
Ik schrijf geen liedjes volgens een methode.

Maar tijdens het schrijven, en misschien nog wel meer tijdens het schrappen, zijn er in de loop van de tijd uitgangspunten ontstaan. Dingen die me helpen beter te kijken naar wat een lied nodig heeft.

Dit zijn geen wetten en ook geen checklist voor een "goed lied". Sommige spreken elkaar zelfs tegen. Dat is niet erg. Een timmerman gebruikt ook niet bij iedere klus hetzelfde gereedschap.

De vraag is nooit:

> Houdt dit lied zich aan de uitgangspunten?
...
3. [Vertrouw de luisteraar](#3-vertrouw-de-luisteraar)
4. [Laat iedere regel zijn eigen werk doen](#4-laat-iedere-regel-zijn-eigen-werk-doen)
5. [Laat het lied reizen](#5-laat-het-lied-reizen)
6. [Schrijf vanuit een stem](#6-schrijf-vanuit-een-stem)
7. [Bewaar, vind en schrap](#7-bewaar-vind-en-schrap)
8. [Gereedschap, geen wet](#8-gereedschap-geen-wet)
...
*Ik mis haar. Ik ben kwaad. Ik ben bang. Ik voel me alleen.*

Dat kan waar zijn, maar het is nog niet noodzakelijk interessant.

Kijk de kamer in.

Wat staat er nog? Wat is verdwenen? Wat doet iemand terwijl hij probeert niet te voelen wat hij voelt?
...
Een trouwring hoeft niet te zeggen dat een huwelijk voorbij is.

Een gedeukt bierblikje op tafel hoeft niet te vertellen wie er boos was, wie er dronk of wie er vertrok.
...
Wat ervoor en erna gebeurt kan hetzelfde beeld volledig veranderen.
...
Een ingepakte koffer die al drie dagen naast de deur staat kan me iets anders laten ervaren.
...
Een lege stoel.  
Een naam die iemand niet meer uitspreekt.  
Een motor die blijft draaien.  
Een afdruk waar een ring heeft gezeten.
...
Soms moet een refrein eindelijk hardop zeggen wat de coupletten alleen maar hebben laten zien.

Maar een emotie krijgt meer gewicht wanneer de luisteraar weet waar ze vandaan komt.

Laat me eerst zien wat jij ziet.
...
Maar soms is wat na het vertrek nog in de kamer ligt interessanter.

Niet alleen letterlijk.

Wat blijft iemand doen nadat de reden ervoor verdwenen is?

Wat draag je mee nadat je dacht dat je iets had achtergelaten?
...
De ruimte tussen twee regels is ook onderdeel van het lied.
...
De luisteraar heeft zelf een leven meegenomen naar het lied.
...
Een lied mag een tijdje niet weten wat het betekent.
...
Dat betekent niet dat al die informatie in het lied moet.

De bron geeft mij precisie.
...
Maar ook dit is geen wet.

Soms geef je juist het adres en niet de sleutel: een exacte plek, datum of gebeurtenis waarvan de betekenis onuitgesproken blijft.
...
Als het eerste beeld verdriet laat zien, hoeft het tweede niet nogmaals verdriet te bewijzen.
...
Sommige regels openen een deur.

Sommige regels veranderen alles.

En sommige regels brengen je gewoon naar de volgende.
...
> and left the ashes where they fell  
> and never wondered why

De tweede regel hoeft niet te concurreren met de eerste.
...
Vooral wanneer het jouw mooiste regel is.

Een regel kan op zichzelf prachtig zijn en het lied toch in de weg zitten.
...
Maar er bestaat een verschil tussen een regel die mooi **is** en een regel die lijkt te weten dat hij mooi is.
...
Andere lijken alsof ze er altijd al lagen en je ze alleen nog moest blootleggen.

Die tweede soort is zeldzaam.
...
Wel ergens anders dan waar het begon.
...
Soms ontdek je dat de vraag waarmee het lied begon niet de echte vraag was.
...
Aan het begin kunnen het geografische woorden zijn.

Aan het einde misschien niet meer.

Het woord veranderde niet.
...
Je begint bij een voorwerp, een zin, een persoon of een gebeurtenis omdat daar iets zit.

Pas tijdens het schrijven ontdek je misschien waar het werkelijk over gaat.
...
Als de coupletten het verdiend hebben, mag een refrein soms precies zeggen wat er aan de hand is.

Het couplet kan fluisteren zodat het refrein kan schreeuwen.
...
Niet iedere verteller ziet wat ik zie.

Een vuurtorenwachter, iemand aan een bar en iemand die met een Telecaster voor een versterker staat praten niet hetzelfde.
...
Andersom kan een autobiografisch correct lied volkomen onecht klinken.
...
Sommige liedjes willen een kier in de deur.

Andere willen hem intrappen.

Een anthem mag weten dat het een anthem is.
...
Je hoeft nog niet te weten wie het zegt, wanneer het gebeurt, waar het is of waarom het belangrijk is.
...
Soms moet alles wat niet sterk genoeg vastzit verdwijnen.
...
Niet steeds iets toevoegen.

Voorzichtig het zand verwijderen totdat zichtbaar wordt wat er al lag.
...
Soms laat je eerst zien.

En dan vertel je het.
...
Soms moet de band inzetten en moet iedereen na één refrein weten waar het over gaat.

Dat is geen artistieke nederlaag.
...
Laat iets open omdat er werkelijk ruimte zit.
...
Soms kijkt hij recht in de spiegel.

Sommige liedjes moeten *ik* zeggen.
...
Een luisteraar mag struikelen.

Een regel mag zelfs een tijdje vreemd blijven.
...
> Is dit een mooie regel?

Maar:

> **Doet dit het werk dat dit lied nodig heeft?**
...
**En schrap wat uitlegt wat al zichtbaar is.**

---

*Deze pagina is geen afgerond manifest. Hij verandert mee met de liedjes.*
